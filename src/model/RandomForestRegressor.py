...
# Train Random Forest models for D+1, D+3, and D+7
...
model_7 = RandomForestRegressor(n_estimators=100, random_state=42)
...
input_value = [49.0, 38.0, 38.0, 20.0, 0, 0, 1]  # Example input
